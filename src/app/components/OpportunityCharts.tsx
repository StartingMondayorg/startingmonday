    ...
    <svg viewBox="0 0 560 280" className={className} role="img" aria-label="Opportunity timing gap: when you enter vs typical candidates">
      ...
      <defs>
        <linearGradient id="timelineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="var(--card)" stopOpacity="0.3" />
          <stop offset="50%" stopColor="var(--card)" stopOpacity="0.1" />
      ...
      <line x1="40" y1="143" x2="520" y2="143" stroke="var(--muted-foreground)" strokeWidth="1.5" />

      {/* Timeline dots - more refined */}
      <circle cx="55" cy="143" r="5.5" fill="var(--muted-foreground)" opacity="0.8" />
      <circle cx="130" cy="143" r="5.5" fill="var(--muted-foreground)" opacity="0.8" />
      <circle cx="205" cy="143" r="5.5" fill="var(--muted-foreground)" opacity="0.8" />
      <circle cx="280" cy="143" r="5.5" fill="var(--muted-foreground)" opacity="0.8" />
      <circle cx="355" cy="143" r="5.5" fill="var(--muted-foreground)" opacity="0.8" />
      <circle cx="430" cy="143" r="5.5" fill="var(--muted-foreground)" opacity="0.8" />
      ...
      <g>
        ...
        <circle cx="130" cy="105" r="6.5" fill="var(--success)" stroke="var(--success)" strokeWidth="1.5" />
        <text x="130" y="32" fill="var(--success)" fontSize="13" fontWeight="600" textAnchor="middle" letterSpacing="0.5">Starting Monday</text>
        <text x="130" y="49" fill="var(--muted-foreground)" fontSize="11" textAnchor="middle">enters before</text>
        <text x="130" y="62" fill="var(--muted-foreground)" fontSize="11" textAnchor="middle">decision-makers</text>
        <text x="130" y="75" fill="var(--muted-foreground)" fontSize="11" textAnchor="middle">form shortlist</text>
      </g>
      ...
      <g>
        ...
        <circle cx="280" cy="105" r="6.5" fill="var(--primary)" stroke="var(--primary)" strokeWidth="1.5" />
        <text x="280" y="32" fill="var(--primary)" fontSize="13" fontWeight="600" textAnchor="middle" letterSpacing="0.5">Typical candidates</text>
        <text x="280" y="49" fill="var(--muted-foreground)" fontSize="11" textAnchor="middle">enter when role</text>
        <text x="280" y="62" fill="var(--muted-foreground)" fontSize="11" textAnchor="middle">is publicly posted</text>
        <text x="280" y="75" fill="var(--muted-foreground)" fontSize="11" textAnchor="middle">& widely known</text>
      </g>
...
export function OpportunityTimingGapChartMobile({ className = 'h-auto w-full' }: { className?: string }) {
  return (
    <svg viewBox="0 0 360 320" className={className} role="img" aria-label="Opportunity timing gap: Starting Monday enters while the role is taking shape; typical candidates enter at the public posting">
      ...
      <circle cx="92" cy="190" r="5" fill="var(--muted-foreground)" />
      <circle cx="139" cy="190" r="5" fill="var(--muted-foreground)" />
      <circle cx="186" cy="190" r="5" fill="var(--muted-foreground)" />
      <circle cx="233" cy="190" r="5" fill="var(--muted-foreground)" />
      <circle cx="280" cy="190" r="5" fill="var(--muted-foreground)" />
      <circle cx="327" cy="190" r="5" fill="var(--muted-foreground)" />

      <line x1="92" y1="160" x2="92" y2="182" stroke="var(--success)" strokeWidth="3.5" strokeLinecap="round" />
      <circle cx="92" cy="155" r="6.5" fill="var(--success)" stroke="var(--success)" strokeWidth="1.5" />
...
export function RoleLandingProbabilityChart({ className = 'h-auto w-full' }: { className?: string }) {
  return (
    <svg viewBox="0 0 600 292" className={className} role="img" aria-label="Role landing probability chart comparing Starting Monday and typical paths">
      <line x1="56" y1="32" x2="56" y2="214" stroke="var(--muted-foreground)" strokeWidth="2" />
      <line x1="56" y1="214" x2="492" y2="214" stroke="var(--muted-foreground)" strokeWidth="2" />

      <rect x="56" y="138" width="436" height="76" fill="var(--card)" opacity="0.32" />
      <rect x="248" y="32" width="244" height="106" fill="var(--success)" opacity="0.26" />
      <line x1="56" y1="178" x2="492" y2="178" stroke="var(--card)" strokeWidth="1" />
      <line x1="56" y1="142" x2="492" y2="142" stroke="var(--card)" strokeWidth="1" />
      <line x1="56" y1="106" x2="492" y2="106" stroke="var(--card)" strokeWidth="1" />
      <line x1="56" y1="70" x2="492" y2="70" stroke="var(--card)" strokeWidth="1" />

      <text x="18" y="218" fill="var(--muted-foreground)" fontSize="12">0%</text>
      <text x="14" y="182" fill="var(--muted-foreground)" fontSize="12">25%</text>
      <text x="14" y="146" fill="var(--muted-foreground)" fontSize="12">50%</text>
      ...
      <line x1="194" y1="214" x2="194" y2="220" stroke="var(--muted-foreground)" strokeWidth="1.5" />
      <line x1="248" y1="214" x2="248" y2="220" stroke="var(--muted-foreground)" strokeWidth="1.5" />
      <line x1="302" y1="214" x2="302" y2="220" stroke="var(--muted-foreground)" strokeWidth="1.5" />
      <line x1="356" y1="214" x2="356" y2="220" stroke="var(--muted-foreground)" strokeWidth="1.5" />
      ...
      <circle cx="194" cy="178" r="5.6" fill="var(--muted-foreground)" />
      <circle cx="248" cy="164" r="5.6" fill="var(--muted-foreground)" />
      <circle cx="302" cy="154" r="5.6" fill="var(--muted-foreground)" />
      <circle cx="356" cy="144" r="5.6" fill="var(--muted-foreground)" />

      <circle cx="84" cy="188" r="6.5" fill="var(--info)" />
      <circle cx="138" cy="171" r="6.5" fill="var(--info)" />
      <circle cx="194" cy="154" r="6.5" fill="var(--info)" />
      <circle cx="248" cy="137" r="6.5" fill="var(--info)" />
      <circle cx="302" cy="120" r="6.5" fill="var(--info)" />
      <circle cx="356" cy="103" r="6.5" fill="var(--info)" />
      <circle cx="410" cy="86" r="6.5" fill="var(--info)" />
      <circle cx="468" cy="70" r="6.5" fill="var(--info)" />
