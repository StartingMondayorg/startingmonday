...
const INDICATOR_COLOR_CLASS: Record<string, string> = {
  'bg-orange-500': '[&_[data-slot=progress-indicator]]:bg-orange-500',
  'bg-emerald-500': '[&_[data-slot=progress-indicator]]:bg-emerald-500',
  'bg-red-400': '[&_[data-slot=progress-indicator]]:bg-red-400',
}
...
function ScoreBar({ score, max = 100, color = 'bg-orange-500' }: { score: number; max?: number; color?: string }) {
  return (
    <Progress
      value={score}
      max={max}
      className={`[&_[data-slot=progress-track]]:h-2 [&_[data-slot=progress-track]]:bg-slate-100 ${INDICATOR_COLOR_CLASS[color] ?? INDICATOR_COLOR_CLASS['bg-orange-500']}`}
    />
  )
}
  ...
  return (
    <div className="space-y-5">
      ...
      <Tabs value={view} onValueChange={(value) => setView(value as 'rankings' | 'criteria' | 'detail')}>
        <TabsList className="w-full rounded-xl border border-slate-200 bg-slate-50 p-1">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      {result.isDisqualified ? (
                        ...
                        <Avatar size="sm" className="bg-orange-100">
          ...
          <div className="space-y-2">
            {criteria.map((c) => (
              <Card key={c.id} className={`flex-row px-4 py-3 items-center gap-3 ${
                c.isHardConstraint ? 'border-red-200 bg-red-50/20' : ''
              }`}>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <Label className="text-[10px] font-normal text-slate-400">Weight</Label>
                  <Slider
              ...
              {activeEval && activeScoringResult && (
                <div className="space-y-4">
                  ...
                  {activeScoringResult.isDisqualified && (
                    <Alert variant="destructive" className="border-red-300 px-5 py-4">
                  ...
                  {!activeScoringResult.isDisqualified && (
                    <div className="grid grid-cols-2 gap-3">
                      <Card className="border-emerald-200 bg-emerald-50/30 p-4 text-center">
                      ...
                      <Card className="border-red-200 bg-red-50/30 p-4 text-center">
                  ...
                  <Card className="border-blue-200 bg-blue-50/20 p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <Textarea
                          ...
                          className="w-full border-blue-200 text-[12px] focus-visible:border-blue-400 resize-none bg-white"
                        />
                      </div>
                      <div>
                      ...
                      {[
                        ...
                        <div key={field}>
                          ...
                          <Input
                            ...
                            className="w-full border-blue-200 text-[13px] focus-visible:border-blue-400"
                          />
                        </div>
                      ))}
                    </div>
