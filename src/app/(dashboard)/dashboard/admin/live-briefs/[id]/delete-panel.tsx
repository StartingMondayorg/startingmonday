...
export default function DeletePanel({ requestId, enabled }: { requestId: string; enabled: boolean }) {
  ...
  return (
    <div className="rounded border border-destructive/20 bg-destructive/10 p-5">
