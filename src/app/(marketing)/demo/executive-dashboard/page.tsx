...
import { DashboardProfileIntelligenceSection } from '@/app/(dashboard)/dashboard/_components/profile-intelligence-section'
import { DashboardWeeklyPerformanceSection } from '@/app/(dashboard)/dashboard/_components/weekly-performance-section'
